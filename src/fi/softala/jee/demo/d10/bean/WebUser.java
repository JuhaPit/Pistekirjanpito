...
public class WebUser {
	...
	public WebUser(int id, String username, String salt, String passwordHash, String demo) {
		super();
		this.id = id;
		this.username = username;
		this.salt = salt;
	...
	public WebUser(int id, String username, String salt, String passwordHash, String demo, String pisteet) {
		super();
		this.id = id;
		this.username = username;
		this.salt = salt;
	...
	public WebUser(String username, String salt, String passwordHash,
			String demo, String pisteet) {
		super();
		this.username = username;
		this.salt = salt;
		this.passwordHash = passwordHash;
	...
	public String toString() {
		return "WebUser [id=" + id + ", username=" + username + ", salt="
				+ salt + ", passwordHash=" + passwordHash + ", demo=" + demo
				+ ", pisteet=" + pisteet + "]";
	}
